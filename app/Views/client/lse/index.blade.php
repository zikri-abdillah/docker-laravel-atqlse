                                ...
                                <div class="col">
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-md-8 mb-0">
                                            <select class="form-control select2-show-search form-select select-jenis-ls" id="s_idJenisLs" name="s_idJenisLs" data-placeholder="-- Silahkan Pilih --" data-allow-clear="true" style="width: 100%;">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control" id="s_noSi" name="s_noSi" type="text" placeholder="Nomor SI">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4" align="right">
                        @if (session()->get('sess_role') == 10) 
                            <a class="btn btn-indigo m-1" href="<?= base_url() ?>/client/lse/input">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        @if ($dataFilter == 'terbit')
                                            <th class="border-bottom-0">LAP. SURVEYOR (LS)</th>
                                        @endif
