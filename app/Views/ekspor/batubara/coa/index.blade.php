                  ...
                  <div class="accordion-body">
                    <form id="frm-tracking-coal" method="POST" return>
                        <div class="row">
                            <div class="col">
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" id="s_namaPerusahaan" name="s_namaPerusahaan"
                            ...
                            <div class="col">
                                <div class="row mb-3">
                                    <label class="col-md-4 form-label">Nomor COA</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="s_nomorCoa" name="s_nomorCoa"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4" align="right">
                        @if (session()->get('sess_role') == 6) 
                            <a class="btn btn-indigo m-1" href="<?= base_url() ?>/ekspor/coa/input">
                    ...
                    <div class="mb-12"> 
                        <div class="table-responsive" style="font-size: 12px;">
                            <table class="table table-bordered w-100" id="coa-list" style="font-size: 12px;">
                                <thead>
                                    <tr>
                                        <th class="bg-data-table border-bottom-0 text-center">No</th>
                                        <th class="bg-data-table border-bottom-0">COA</th>
