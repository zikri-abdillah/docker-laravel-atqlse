<div class="card">   
    ...
    <h5 class="card-title fw-semibold mb-3">{{ $page_title }}</h5>
        ...
        <div class="tab-content">
                                 ...
                                 <div class="row">
                                       <div class="col">
                                          <div class="row mb-3">
                                             ...
                                             <div class="col-md-8">
                                                   {{ $datals->bentukPersh." ".$datals->namaPersh }}
                                             </div>
                                          </div>
                                          <div class="row mb-3">
                              ...
                              <div class="card-body mt-4">
                                 <div class="row">
                                       <div class="col">
                                          ...
                                          <div class="row mb-3">
                                             <label class="col-md-4 form-label">Nomor Invoice</label>
                                             <div class="col-md-8">
                                                {{ $datals->noInvoice }}
                                             </div>
                                          </div>
                                          <div class="row mb-3">
                                             <label class="col-md-4 form-label">Tanggal Invoice</label>
                                             <div class="col-md-8">
                                                {{ reverseDate($datals->tglInvoice??'') }}
                                             </div>
                                          </div>
                                       </div>
                                       <div class="col">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col">
                                       ...
                                       <div class="row mb-3">
                                          ...
                                          <div class="col-md-8">
                                             {{ formatAngka($datals->kapasitasKapal) }}
                                          </div>
                                       </div>
                                       <div class="row mb-3">
                                       ...
                                       <tbody>
                                             @foreach ($containers as $container)
                                                <tr>
                                                   ...
                                                   <td class="text-nowrap">{{ $container->noSegel }}</td>
                                                </tr>
                                             @endforeach
                                       </tbody>
                                    </table>
            ...
            <div class="tab-pane" id="tabRoyalti"> 
               <div class="table-responsive mt-3">
                  <table class="table table-striped table-hover w-100" id="tab-ntpn">
                        <thead>
                           <tr>
                              <th class="text-center">#</th>
                              <th>NTPN / Royalti</th>
                        ...
                        <tbody>
                           @foreach ($royaltis as $ntpn)
                              <tr>
                                 <td>{{ $loop->iteration }}</td>
                                 <td>{!! $ntpn->noNtpn.'<br>'.reverseDate($ntpn->tglNtpn).'<br>'.formatAngka($ntpn->royalti).' ('.$ntpn->currency.')' !!}</td>
                                 <td>{!! $ntpn->nama.'<br>NPWP: '.formatNPWP($ntpn->npwp).'<br>NIB: '.$ntpn->nib.'<br>NITKU: '.$ntpn->nitku !!}</td>
                                 <td>{!! $ntpn->namaProp.'<br>'.formatAngka($ntpn->volume).'('.$ntpn->kdSatuan.')' !!}</td>
                  ...
                  <table id="table-kalori" class="table table-striped table-hover">
                     ...
                     <tbody>
                        @foreach ($kalori as $data)
                           <tr>
                              <td align="middle">{{ $data->seri }}</td> 
                              <td align="middle">{{ formatHS($data->postarif) }}</td> 
                              <td align="middle">{{ formatAngka($data->calArb) }}</td>  
                              <td align="middle">{{ formatAngka($data->calAdb) }}</td>  
                              <td align="middle">{{ formatAngka($data->tmArb) }}</td>  
                              <td align="middle">{{ formatAngka($data->tAsh) }}</td>  
                              <td align="middle">{{ formatAngka($data->tSulfur) }}</td>  
                              <td align="middle">{{ $data->klasifikasiBatubara }}</td>  
                              <td align="middle">{{ $data->keterangan }}</td>  
                           </tr>
                        @endforeach
                     </tbody>
                  </table>
        ...
        <div class="col-md-12 mt-2 text-center"> 
            ...
            @if (session()->get('sess_role') == 6 && $datals->statusDok == 'TERBIT' && $datals->statusProses == 'ISSUED' && $datals->statusKirim == 'SENT')  
