<div class="card">   
    ...
    <h5 class="card-title fw-semibold mb-3">{{ $page_title }}</h5>
        <ul class="nav tabs-menu-form">
            ...
            <li>
                <a href="#tabKomoditasIzin" data-bs-toggle="tab" id="buttonKomoditasIzin">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-invoice" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" /><path d="M9 7l1 0" /><path d="M9 13l6 0" /><path d="M13 17l2 0" /></svg>
                    Cek Izin
                </a>
            </li>  
        ...
        <div class="tab-content">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="form-group col-md-8">
                                                        ...
                                                        @else 
                                                            <select class="form-control select2-show-search form-select select-jenis-ls" id="i_idJenisLS" name="i_idJenisLS" data-placeholder="-- Pilih --" style="width: 100%;">
                                                                <option label="-- Pilih --"></option>
                                                                @if (!empty($datals->idJenisLS))
                                                                    <option value="{{ $datals->idJenisLS }}" selected>{{ $datals->markJenisLS }}</option>
                                                                @endif
                                                            </select>
                                                        @endif
                                                        <span id="lbl-lse-spe" class="text-warning" style="font-size: smaller;"></span>
                                                    </div>
                                                </div> 
            ...
            <div class="tab-pane" id="tabKomoditasIzin">   
                @if ( session()->get('sess_role') == 6 || (session()->get('sess_role') == 7 && config('App')->spv_can_edit ) ) 
                    <div class="card mb-0 mt-2"> 
                        <div class="card-header">  
                            <a class="btn btn-secondary btn-sm" href="javascript:void(0)" onclick="checkIzin()">
                                <i class="fa fa-refresh me-2" aria-hidden="true"></i>Check Izin
                            </a> 
                            <br>
                            <p class="text-danger div-izin-notfound">Data perizinan tidak ditemukan. Pastikan data SPE yang di input pada tab Dokumen Referensi benar dan sudah melakukan check izin</p>
                        </div> 
                        <div class="card-body">  
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="row mb-4">
                                        <label class="col-md-4 form-label">IDTKU</label>
                                        <div class="col-md-8"> 
                                            :
                                        </div>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="row mb-4">
                                        <label class="col-md-4 form-label">Nomor Izin</label>
                                        <div class="col-md-8">
                                            :
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label class="col-md-4 form-label">Tanggal Awal Izin</label>
                                        <div class="col-md-8">
                                            :
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <label class="col-md-4 form-label">Tanggal Akhir Izin</label>
                                        <div class="col-md-8">
                                            :
                                        </div>
                                    </div>
                ...
                <div class="card"> 
                    <div class="card-body"> 
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane p-1" id="tabIzin" role="tabpanel">  
                    ...
                    <table id="table-komoditas" class="table text-md-nowrap table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Seri Izin</th>
