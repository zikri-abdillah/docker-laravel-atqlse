              ...
              <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                    <form id="frm-tracking-mineral" method="POST" return>
                        <div class="row">
                            <div class="col">
                                <div class="row mb-3">
                        ...
                        <div class="row">
                            <div class="mt-3 text-center">
                                <button type="reset" id="btn-reset-mineral" class="btn btn-danger btn-sm">
                                ...
                                <button type="button" id="btn-tracking-mineral" class="btn btn-primary btn-sm">
                                    <i class="fa fa-search" aria-hidden="true"></i> Search
                                </button>
                                <button type="button" id="btn-export-mineral" class="btn btn-success btn-sm">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4" align="right">
                        @if (session()->get('sess_role') == 6) 
                            <a class="btn btn-indigo m-1" href="<?= base_url() ?>/ekspor/mineral/ls/input">
                    ...
                    <div class="mb-12"> 
                        <div class="table-responsive" style="font-size: 12px;">
                            <table class="table table-bordered w-100" id="table-mineral">
                                <thead>
                                    <tr>
