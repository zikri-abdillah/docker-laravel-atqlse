...
<body>
	...
	<table style="width:100%;border: 1px solid black;border-spacing: 0; margin-bottom: 100px;">
		...
		<tr>
			<td colspan="9" class="fw-bold text-center"><u>Peraturan Menteri Perdagangan Nomor 23 Tahun 2023 Tentang Kebijakan Dan <br>Pengaturan Ekspor sebagaimana terlah diubah terakhir dengan Peraturan Menteri Perdagangan Republik Indonesia Nomor 9 Tahun 2025.</u></td>
		</tr>
		<tr>
			<td colspan="9" class="text-center"><i>Minister of Trade Regulation Number 23 of 2023 concerning Export Policy and Regulation, as last amended by Minister of Trade Regulation Number 9 of 2025 (Third Amendment)</i></td>
		</tr>
				...
				<table style="padding:0;margin:0;border-spacing:0;border-top:1px solid black;width: 100%;">
					<tr>
						<td style="border-spacing:0;width: 50%;border-right: 1px solid black;border-top: 0; padding-left: 5px;padding-top: 5px;">
							<table style="border-spacing:0;border:0;width: 100%;">
								<tr> <td style="border-top: 0;"><u>EKSPORTIR (NIB, NAMA, ALAMAT)</u><br><i>EXPORTER (NIB, NAME, ADDRESS)</i></td> </tr>
								<tr> <td style="border-top: 0;">{{ $datals->nib }}</td> </tr>
					...
					<tr>
						<td style="border-spacing:0;width: 50%;border-right: 1px solid black;border-top: 1px solid black; padding-left: 5px;padding-top: 5px; vertical-align: top;">
							<table style="border-spacing:0;border:1;width: 100%;">
								<tr>
									<td colspan="4" style="border-top: 0;"><u>ET-BATUBARA</u><br><i>REGISTERED EXPORTER</i></td>
								</tr>
								<tr>
					...
					<tr>
						...
						<td style="border: 0;padding:0;margin:0; padding-top: 5px;vertical-align: top;border-top: 1px solid black;">
							<table style="border:0;border-spacing:0;padding:0;margin:0;width: 100%;">
								<tr>
									<td rowspan="2" style="padding-left: 5px;border: 0;vertical-align: top;width: 220px;"><u>PKP2B / IUPK SEBAGAI KELANJUTAN OPERASI KONTRAK/PERJANJIAN/IUP OP/IUP/IUPK OP/IUPK</u><br><i>MINING LICENSE</i></td>
					...
					<tr>
						...
						<td rowspan="2" style="border: 0;padding:0;margin:0; padding-top: 5px;vertical-align: top;border-top: 1px solid black;">
							<table style="border:0;border-spacing:0;padding:0;margin:0;width: 100%;">
								<tr>
									<td rowspan="2" style="padding-left: 5px;border: 0;vertical-align: top;width: 220px;"><u>IUP OP KHUSUS PENGANGKUTAN DAN PENJUALAN/ IZIN PENGANGKUTAN DAN PENJUALAN</u><br><i>TRANSPORTING AND SELLING LICENCE</i></td>
									<td style="border:0;width: 20px;padding-left:20px;vertical-align:top;">NO.</td>
					...
					<tr>
						<td style="border-spacing:0;width: 35%;border-right: 1px solid black;border-top: 1px solid black; padding-left: 5px; vertical-align: top;">
							<table style="border-spacing:0;border:0;width: 100%;">
								<tr>
									<td style="border:0;width: 100px; vertical-align: middle;"><u>NAMA KAPAL</u><br><i>VESSEL NAME</i></td>
									<td style="border:0;width: 5px;">:</td>
									<td style="border:0;">{{ $datals->namaTransport }}</i></td>
								</tr>
							</table>
						</td>
						<td style="border: 0;padding:0;margin:0; vertical-align: middle;border-top: 1px solid black;">
							<table style="border:0;border-spacing:0;padding:0;margin:0;width: 100%;">
								<tr>
									<td style="padding-left: 4px;border: 0;vertical-align: middle;width: 25%;"> 
									  	<u>JENIS KAPAL / BENDERA</u><br><span><i>TYPE/FLAG</i>
									</td>
									<td style="border:0;width: 1%;">:</td>
									<td style="border:0;padding-left:5px;vertical-align:middle;width: 23%;">
										{{ $datals->cargoType.' / '.strtoupper($datals->benderaKapal) }}
									</td> 
									<td style="padding-left: 15px; border: 0;vertical-align: middle;width: 28%;">
										<span><u>TGL. PEMUATAN DI VESSEL/ STUFFING</u><br><i>DATE OF LOADING/ STUFFING</i></span>
									</td>
									<td style="border:0;width: 1%;">:</td>
									<td style="border: 0;vertical-align: middle;width: 22%;">{{ formatDate($datals->tglMuat).' s/d '.formatDate($datals->tglMuatAkhir) }}</td>
								</tr>
							</table>
						</td>
					</tr>
					...
					@php  
						$transhipment = $datals->transhipment == 1 ? 'YA': 'TIDAK';
					@endphp
					...
					<tr>
						<td style="border-spacing:0;width: 35%;border-right: 1px solid black;border-top: 1px solid black; padding-left: 5px; vertical-align: top;">
							<table style="border-spacing:0;border:0;width: 100%;">
								<tr>
									<td style="border:0;width: 100px;"><u>KAPASITAS KAPAL</u><br><i>VESSEL BARGE CAP</i></td>
									<td style="border:0;width: 5px;">:</td>
									<td style="border:0;">{{ formatAngka($datals->kapasitasKapal) }}</i></td>
								</tr>
							</table>
						</td>
						<td style="border: 0;padding:0;margin:0;vertical-align: middle;border-top: 1px solid black;">
							<table style="border:0;border-spacing:0;padding:0;margin:0;width: 100%;">
								<tr>
									<td style="padding-left: 5px;border: 0;white-space: nowrap;">
										<span>TRANSHIPMENT</span><span style="margin-left:5px">:</span><span style="margin-left:5px;margin-right:10px;">{{ $transhipment }}</span>
									</td>
									<td style="border: 0;white-space: nowrap;">
										<span style="margin-right: 5px;"><u>NAMA PERUSAHAAN ASURANSI</u><br><i>INSURANCE</i></span>
									</td>
									<td style="width:2px;border:0;vertical-align:middle;">:</td>
									<td style="border: 0;">{{ $datals->namaAsuransiKargo }}</td>
								</tr>
							</table>
						</td>
					</tr>
		...
		<tr class="tr-collapse">
			<td colspan="9" style="padding:0;margin:0;border-spacing:0;border:0;width: 100%;">
				<table style="padding:0;margin:0;border-spacing:0;border-top:1px solid black;width: 100%; vertical-align: middle">
					<tr>
						{{-- Kolom kiri --}}
						<td style="width:50%;border: 0; border-top: 0; padding: 0;border-right: 1px solid black;"> 
							@php
								...
								foreach ($containers as $key => $container) {
									$noContainers .= strtoupper($container->nomor).', ';
								}

								$noContainers = $noContainers ? substr($noContainers, 0,strlen($noContainers)-2) : '-';
								$namaTransport = $datals->namaTransport?: '-';
							@endphp 

							<table style="border:0;border-spacing:0;padding:0;padding-top: 5px;">
								<tr>
									<td style="padding-left: 5px;border: 0;vertical-align: middle;">ALAT ANGKUT/<i>MODE OF TRANSPORT</i></td> 
									<td style="border: 0;vertical-align: middle;">:</td>
									<td style="border:0;padding-left:5px;vertical-align:middle;">{{ 'CONTAINERS ('.$noContainers.') / VESSEL ('.$datals->namaTransport.')' }}</td> 
								</tr> 
							</table> 
						</td>
						{{-- Kolom kanan --}}
						<td style="width:50%;border: 0;border-top: 0; padding: 0;">
							<table style="border-spacing:0;border:0;width: 100%;">
								<tr>
									<td style="border-right: 0;border-top: 0;border-right: 0; padding-left: 5px; vertical-align: middle">TIPE PEMUATAN (CARGO TYPE) <span style="margin-left:5px;margin-right:5px;">:</span> {{ $datals->tipeMuat }}</td>
								</tr>
							</table>
						</td>
					</tr>
						...
						<td colspan="2" style="width:100%;border: 0; border-top: 0; border-right: 0;padding: 0;">
							<table style="border-spacing:0;border:0;width: 100%;">
								<tr>
									...
									<td style="text-align: center; width: 70px; border-right: 0;border-top: 1px solid black; border-right: 1px solid black;padding-left: 5px;padding-top: 5px;"><u>JUMLAH (TNE)</u><br><i>QUANTITY (TNE)</i></td>
									<td style="text-align: center; width: 70px; white-space:nowrap; border-right: 0;border-top: 1px solid black; border-right: 1px solid black;padding-left: 5px;padding-top: 5px;"><u>FOB (USD/IDR)</u><i>FOB (USD/IDR)</i></td>
									<td style="text-align: center; border-right: 0;border-top: 1px solid black; border-right: 0;padding-left: 5px;padding-top: 5px;"><u>NO. IUP OP/PKP2B/IUPK OP ASAL BARANG</u><br><i>MINING LICENSE OF GOODS ORIGINS</i></td>
								</tr>
								@php
									$noPetikemas ='';
									$totalBarang = 0;
								...
								@endphp
									<tr>
										...
										<td style="text-align: center; border-right: 0;border-top: 1px solid black; border-right: 1px solid black;padding-left: 5px;padding-top: 5px;">{{ formatAngka($barang->hargaBarangUsd).' / '.formatAngka($barang->hargaBarangIdr) }}</td>
						...
						<td colspan="2" style="width:100%;border: 0; border-top: 0; border-right: 0;padding: 0;">
							<table style="border-spacing:0;border:0;width: 100%;">
								<tr>
									...
									<td style="text-align: center; width: 120px; border-right: 0;border-top: 1px solid black;  border-right: 1px solid black;padding-left: 5px;padding-top: 5px;"><u>PROPINSI ASAL BARANG</u><br><i>PROVINCE</i></td>
									<td style="text-align: center;border-right: 0;border-top: 1px solid black; border-right: 0;padding-left: 5px;padding-top: 5px;"><u>PEMBAYARAN ROYALTI (USD/IDR)</u><br><i>ROYALTI PAID (USD/IDR)</i></td>
								</tr>
					...
					<tr>
						<td colspan="2" style="width:100%;border: 0; border-top: 0; border-right: 0;padding: 0;">
							<table style="border-spacing:0;border:0;width: 100%;">
								<tr>
									<td width="50%" style="text-align: left; border-right: 0;border-top: 1px solid black;padding-left: 5px;padding-top: 5px;">CATATAN / NOTE <span style="margin-left:10px;margin-right:10px;">:</span> {{ $datals->catatanPeriksa }} </td>
									...
									<td width="50%" style="text-align: left; border-right: 0;border-top: 1px solid black;padding-left: 5px;padding-top: 5px;">TANGGAL /<i>DATE</i> <span style="margin-left:10px;margin-right:10px;">:</span> {{ $datals->tglPeriksa ? formatDate($datals->tglPeriksa) : '' }} </td>
								</tr>
							</table>
						</td>
					</tr>
								...
								<tr>
									<td style="width:50%">
										<table style="border:0">
											...
											<tr>
												<td style="border:0"><b>Barang Yang Diperiksa Sesuai <u>Peraturan Menteri Perdagangan Nomor 23 Tahun 2023 Tentang Kebijakan Dan Pengaturan Ekspor sebagaimana terlah diubah terakhir dengan Peraturan Menteri Perdagangan Republik Indonesia Nomor 9 Tahun 2025.</b></u><br><i>Goods Verificated Found In Compliance With Minister of Trade Regulation Number 23 of 2023 concerning Export Policy and Regulation, as last amended by Minister of Trade Regulation Number 9 of 2025 (Third Amendment)</i></td>
											</tr>
										</table>
									</td>
