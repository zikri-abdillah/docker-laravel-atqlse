 ...
 *  $config->apiKey
 */
class Batubara_xml extends BaseController
{
	protected $logStart;
	protected $jenisLS;
	protected $idLS;
	...
	{
        helper('api');
        $this->jenisLS = '01994'; // pastikan sudah sesuai
    ...
    // for testing url = services/xml/coal/test_send_inatrade
    // testing ini tetap hit ke endpoint yang ditentukan pada fungsi send act!!!!!
    public function test_send_inatrade()
    {
    	$postId = encrypt_id(74);
    	if($postId)
    	{
