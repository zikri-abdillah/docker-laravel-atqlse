...
document.getElementById("layout-menu") && (isHorizontalLayout = document.getElementById("layout-menu").classList.contains("menu-horizontal")),
    function() {
        ...
        var o, a = document.querySelector(".dropdown-style-switcher"),
            ...
            }), a = a.querySelector("i"), "light" === n ? (a.classList.add("bx-sun"), new bootstrap.Tooltip(a, {
                title: "Light Mode",
                fallbackPlacements: ["bottom"]
            })) : "dark" === n ? (a.classList.add("bx-moon"), new bootstrap.Tooltip(a, {
                title: "Dark Mode",
                fallbackPlacements: ["bottom"]
            })) : (a.classList.add("bx-desktop"), new bootstrap.Tooltip(a, {
                title: "System Mode",
                fallbackPlacements: ["bottom"]
            }))), "system" === (o = n) && (o = window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), [].slice.call(document.querySelectorAll("[data-app-" + o + "-img]")).map(function(e) {
        ...
        // a = "search-vertical.json", $("#layout-menu").hasClass("menu-horizontal") && (a = "search-horizontal.json"), o = $.ajax({
        ...
        //                 meta: a
        //             }) {
        //                 return '<a href="javascript:;"><div class="d-flex w-50"><img class="me-3" src="' + assetsPath + e + '" alt="' + t + '" height="32"><div class="w-75"><h6 class="mb-0">' + t + '</h6><small class="text-muted">' + o + '</small></div></div><small class="text-muted">' + a + "</small></a>"
        //             },
